...
class QuoteCog(commands.Cog):
    ...
    async def remove_quote(self, interaction: Interaction, quote: str):
        try:
            ...
            save_quotes(self.quotes)
            await interaction.response.send_message(f"🗑️ Removed: '{quote}'")
    ...
    async def cog_load(self):
        ...
        self.bot.tree.add_command(self.add_quote)
        self.bot.tree.add_command(self.remove_quote)
        self.bot.tree.add_command(self.list_quotes)
        self.bot.tree.add_command(self.download_quotes)
